...
android { namespace = "com.dailyrecord.app"; compileSdk = 35
    defaultConfig { applicationId = "com.dailyrecord.app"; minSdk = 23; targetSdk = 35; versionCode = 1; versionName = "1.0" }
}
